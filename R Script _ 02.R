...
Hits.min <- round(min(mydata$Hits) * 100, 1)
Hits.max <- round(max(mydata$Hits) * 100, 1)
Hits.mean <- round(mean(mydata$Hits) * 100, 1)
Hits.median <- round(median(mydata$Hits) * 100, 1)
Hits.skewness <- round(skewness(mydata$Hits) * 100, 1)
...
Average.Request.Size.Bytes.min <- round(min(mydata$Average.Request.Size.Bytes) * 100, 1)
Average.Request.Size.Bytes.max <- round(max(mydata$Average.Request.Size.Bytes) * 100, 1)
Average.Request.Size.Bytes.mean <- round(mean(mydata$Average.Request.Size.Bytes) * 100, 1)
Average.Request.Size.Bytes.median <- round(median(mydata$Average.Request.Size.Bytes) * 100, 1)
Average.Request.Size.Bytes.skewness <- round(skewness(mydata$Average.Request.Size.Bytes) * 100, 1)
...
Attack.Window.Seconds.min <- round(min(mydata$Attack.Window.Seconds) * 100, 1)
Attack.Window.Seconds.max <- round(max(mydata$Attack.Window.Seconds) * 100, 1)
Attack.Window.Seconds.mean <- round(mean(mydata$Attack.Window.Seconds) * 100, 1)
Attack.Window.Seconds.median <- round(median(mydata$Attack.Window.Seconds) * 100, 1)
Attack.Window.Seconds.skewness <- round(skewness(mydata$Attack.Window.Seconds) * 100, 1)
...
Average.Attacker.Payload.Entropy.Bits.min <- round(min(mydata$Average.Attacker.Payload.Entropy.Bits) * 100, 1)
Average.Attacker.Payload.Entropy.Bits.max <- round(max(mydata$Average.Attacker.Payload.Entropy.Bits) * 100, 1)
Average.Attacker.Payload.Entropy.Bits.mean <- round(mean(mydata$Average.Attacker.Payload.Entropy.Bits) * 100, 1)
Average.Attacker.Payload.Entropy.Bits.median <- round(median(mydata$Average.Attacker.Payload.Entropy.Bits) * 100, 1)
Average.Attacker.Payload.Entropy.Bits.skewness <- round(skewness(mydata$Average.Attacker.Payload.Entropy.Bits) * 100, 1)
...
Attack.Source.IP.Address.Count.min <- round(min(mydata$Attack.Source.IP.Address.Count) * 100, 1)
Attack.Source.IP.Address.Count.max <- round(max(mydata$Attack.Source.IP.Address.Count) * 100, 1)
Attack.Source.IP.Address.Count.mean <- round(mean(mydata$Attack.Source.IP.Address.Count) * 100, 1)
Attack.Source.IP.Address.Count.median <- round(median(mydata$Attack.Source.IP.Address.Count) * 100, 1)
Attack.Source.IP.Address.Count.skewness <- round(skewness(mydata$Attack.Source.IP.Address.Count) * 100, 1)
...
Average.ping.to.attacking.IP.milliseconds.min <- round(min(mydata$Average.ping.to.attacking.IP.milliseconds) * 100, 1)
Average.ping.to.attacking.IP.milliseconds.max <- round(max(mydata$Average.ping.to.attacking.IP.milliseconds) * 100, 1)
Average.ping.to.attacking.IP.milliseconds.mean <- round(mean(mydata$Average.ping.to.attacking.IP.milliseconds) * 100, 1)
Average.ping.to.attacking.IP.milliseconds.median <- round(median(mydata$Average.ping.to.attacking.IP.milliseconds) * 100, 1)
Average.ping.to.attacking.IP.milliseconds.skewness <- round(skewness(mydata$Average.ping.to.attacking.IP.milliseconds) * 100, 1)
...
Average.ping.variability.min <- round(min(mydata$Average.ping.variability) * 100, 1)
Average.ping.variability.max <- round(max(mydata$Average.ping.variability) * 100, 1)
Average.ping.variability.mean <- round(mean(mydata$Average.ping.variability) * 100, 1)
Average.ping.variability.median <- round(median(mydata$Average.ping.variability) * 100, 1)
Average.ping.variability.skewness <- round(skewness(mydata$Average.ping.variability) * 100, 1)
...
Individual.URLs.requested.min <- round(min(mydata$Individual.URLs.requested) * 100, 1)
Individual.URLs.requested.max <- round(max(mydata$Individual.URLs.requested) * 100, 1)
Individual.URLs.requested.mean <- round(mean(mydata$Individual.URLs.requested) * 100, 1)
Individual.URLs.requested.median <- round(median(mydata$Individual.URLs.requested) * 100, 1)
Individual.URLs.requested.skewness <- round(skewness(mydata$Individual.URLs.requested) * 100, 1)
...
IP.Range.Trust.Score.min <- round(min(mydata$IP.Range.Trust.Score) * 100, 1)
IP.Range.Trust.Score.max <- round(max(mydata$IP.Range.Trust.Score) * 100, 1)
IP.Range.Trust.Score.mean <- round(mean(mydata$IP.Range.Trust.Score) * 100, 1)
IP.Range.Trust.Score.median <- round(median(mydata$IP.Range.Trust.Score) * 100, 1)
IP.Range.Trust.Score.skewness <- round(skewness(mydata$IP.Range.Trust.Score) * 100, 1)
# **********************************************************
